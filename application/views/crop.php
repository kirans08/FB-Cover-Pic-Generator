...
<body>
 <br>
        ...
        <ul class="progress-indicator">
            ...
            <li class="completed">
                <span class="bubble" ></span>
                <a href="<?php echo base_url('index.php/select_profile') ?>" style="text-decoration:none;"><h4 class="finishlink">Select Pic</h4></a>
            </li>
            <li >
                <span class="bubble"></span>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" id="croppedImageModal"></div>
                  ...
                  <div class="row">  
<div class="text-center">
                <button class="btn btn-success " id="saveimage" data-method="getData" data-option="" data-target="putData" type="button">SELECT</button>
 </div>
