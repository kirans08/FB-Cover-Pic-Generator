...
<ul class="progress-indicator">
    ...
    <li class="completed">
        <span class="bubble"></span>
        <a href="<?php echo base_url('select_cover') ?>" style="text-decoration:none;"><h4 class="finishlink">Select
                Cover</h4></a>
    </li>
    <li>
        <span class="bubble"></span>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="text-center " style="margin-top:2em">
            ...
            <a href="https://www.facebook.com/dialog/share?app_id=751168788325921&display=touch&href=http://coverphoto.rithu.org&redirect_uri=http://coverphoto.rithu.org/post_cover"
               class="btn btn-lg  setcover-button" role="button">SET AS COVER PHOTO</a>
